...
public class QueueEventListener implements ServletContextListener, MessageListener {
	private String URL = PropertiesUtil.getKeyValue("ACTIVEMQ_URL");
	private String QUEUE = PropertiesUtil.getKeyValue("ACTIVEMQ_QUEUE");
	...
	public void onMessage(Message message) {
		...
		try {
			logger.info("获取消息内容为 :" + msg.getText());
